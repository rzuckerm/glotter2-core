...
Thank you for your desire to contribute to Glotter2-Core!
...
## Glotter2-Core Development Environment

### Dependencies

Before you can build Glotter2-Core, there a few things you will need.

- [python] and [uv][uv]: Glotter2-Core is written in python and uses `uv` to install dependencies in
  a virtual environment that isolates the dependencies for this project from the dependencies
  on your host system.
- [make]: Everything in Glotter2-Core is built and run using `make`. See the following installation
  guides:
...
The file structure of Glotter2-Core looks like the following (with omissions):
...
The `src/glotter/code` directory contains all source code for the project.
...
The `test` directory contains all unit tests for the project.

`Makefile` contains all the rules for building and running the projects.

The `pyproject.toml` contains all the dependenies of Glotter2-Core and all of the development
...
[README]: https://github.com/rzuckerm/glotter2-core#glotter2-core
[Code of Conduct]: https://github.com/rzuckerm/glotter2-core/blob/main/CODE_OF_CONDUCT.md
[GitHub Actions]: https://github.com/rzuckerm/glotter2-core/actions/workflows/makefile.yml

[docs]: https://rzuckerm.github.io/glotter2-core/
